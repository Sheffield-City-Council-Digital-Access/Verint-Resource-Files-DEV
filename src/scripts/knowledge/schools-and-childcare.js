...
const freeSchoolMeals = new ContentFSM(
  ...
  `
    ...
    <p>The hours must be taken over a minimum of 38 weeks (15 hours a week, or 30 if entitled to additional hours) but can
      ...
      for Families, please contact the Family Hubs - <a href="tel:0114 273 5665">0114 273 5665</a>.</p>
    ...
    <p>HMRC: <<a href="www.childcarechoices.gov.uk">www.childcarechoices.gov.uk</a></p>
    <p>From September 2025 eligible working parents of children from 9 months to school age will be entitled to 30 hours of
      childcare a week.</p>
    <details class="accordion">
      ...
      <div class="accordion-content">
        <details class="details-accordion">
          ...
          <div class="details-accordion-content">
            <p>If your circumstances change, such as if you no longer receive benefits, have moved house, or the school
              attended has changed, this may affect your right to claim, and you should reapply for Free School Meals.</p>
          </div>
        </details>
        <details class="details-accordion">
          ...
          <div class="details-accordion-content">
            <p>Applying for free school meals is very important because the amount of money that your child’s school
              receives from central government depends on the number of children registered as entitled to free school
              meals. The government has also stated that it is keen for universities to actively recruit pupils that have
              previously received free school meals so it is important that those eligible for free school meals do register
              for them. Most importantly, receiving up free school meals will save you around £360 per year per child and
              enable your child to have a balanced and nutritious lunch.</p>
          </div>
        </details>
        <details class="details-accordion">
          ...
          <div class="details-accordion-content">
            <p>Although Primary School Children within the year groups: Reception, Year 1 and Year 2 automatically receive
              Free School Meals, we recommend people still apply for Free School Meals as this provides Funding to the
              Schools via Pupil Premium.</p>
            <p>Children within the Year groups 3 - 6 can only receive a free school meal if their parents/carers are
              eligible and if a Free School Meals Application Form has been completed. You must therefore complete a Free
              School Meals Application Form so that your eligibility can be checked by the Free School Meals Team. If you
              are eligible, your child will start receiving their free school meal.</p>
          </div>
        </details>
        <details class="details-accordion">
          ...
          <div class="details-accordion-content">
            <p>Secondary school pupils can only receive a free school meal if their parent/carer is eligible and if a Free
              School Meals Application Form has been completed. You must therefore complete a Free School Meals Application
              Form so that your eligibility can be checked by the Free School Meals Team. If you are eligible, your child
              can then take up their free school meal.</p>
          </div>
        </details>
        <details class="details-accordion">
          ...
          <div class="details-accordion-content">
            <p>Over 16s can still receive free school meals if they are staying in education at a sixth form. You should
              complete a Free School Meals Application Form. The process is the same as the process for secondary school
              applications. All year 11 pupils applying for the 16-19 bursary fund to help with their place in sixth form in
              the following year will need to complete a free school meals application form in order to apply for the
              bursary. The 16-19 bursary is the new fund available to support students aged 16 to 19 to stay in education
              and is the replacement for the Education Maintenance Allowance (EMA).</p>
          </div>
        </details>
        <details class="details-accordion">
          <summary>What do I do if my child attends an Academy?</summary>
          <div class="details-accordion-content">
            <p>Academies applications are the same for free school meals as other schools. If your child attends an academy,
        ...
        <details class="details-accordion">
          ...
          <div class="details-accordion-content">
            <p>We will let the school know whether or not your child is entitled to free school meals. Your child will hen
              be able to take up their free school meal if eligible. We may also contact you if we need further information
        ...
        <details class="details-accordion">
          ...
          <div class="details-accordion-content">
            <p>You do not have to provide proof of benefits when completing the Free School Meals Application Form as we can
              check for eligibility against a central government database. If our checks indicate that you are not entitled
              to free school meals and you think that you should be entitled, we may have to ask for proof of the benefit
              you are receiving so that we can double check that the details we hold are correct.</p>
          </div>
        </details>
        <details class="details-accordion">
          ...
          <div class="details-accordion-content">
            <p>If a previous application for free school meals was not successful and a change in your circumstances means
              that you think you may now be eligible please contact the Free School Meals Team. You will need to complete
              another application form. If your child currently receives a free school meal and you start work, start to
              receive Working Tax Credit, or stop receiving one of the qualifying benefits you must notify us as soon as
              possible.</p>
          </div>
        </details>
        <details class="details-accordion">
          ...
          <div class="details-accordion-content">
            <p>It is important that you apply as soon as possible as we are unable to backdate claims for free school meals
              to cover unpaid dinner money, or to refund dinner money paid prior to the date of a successful application.
            </p>
          </div>
        </details>
        <details class="details-accordion">
          ...
          <div class="details-accordion-content">
            <p>If your child has moved schools their circumstances will have changed so they may need to apply for Free
              School Meals once again for their new school.</p>
          </div>
        </details>
        <details class="details-accordion">
    ...
    <section>
      ...
      <p>You can redeem your eCode button on the website:
        <a
          href="https://www.edenred.co.uk/reward-recipients/Free-School-Meal-Vouchers/">https://www.edenred.co.uk/reward-recipients/Free-School-Meal-Vouchers/</a>
      </p>
      ...
      <p>
        ...
        Meal line where their entitlement can be checked.
      </p>
      ...
      <p>
        ...
        those children already registered for Free School Meals
      </p>
      <p>
