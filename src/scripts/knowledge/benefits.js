...
<h3>How will I get my Sheffield Crisis Grant</h3>
 ...
 <p>
    ...
    and required identification documents by the adviser or officer who has processed your application. </p>
...
const whoCanApplyForIndependenceGrant = new ContentB(
  ...
  <p> You may be able to get a Sheffield Independence Grant if: </p>
    ...
    <p> You are getting one of the qualifying benefits listed below or are assessed to have insufficient income to meet your needs: </p>
  ...
  <ul>
    ...
    <p>
    If you are not receiving qualifying benefit, you will need to provide bank statements for the last 3 months for us to consider your application. 
...
const WhatIndependanceGrantInformationIsItFor = new ContentB(
  ...
  <ul>
    <li>You, a member of your family, someone you look after or someone you will be looking after, to return to the community from care</li> 
    <li>You, a member of your family, someone you look after or someone you will be looking after, to return to the community from prison</li> 
    <li>You, a member of your family, someone you look after or someone you will be looking after, to stay in the community instead of going into care</li> 
    <li>Ease exceptional pressure on individuals and families *</li> 
    <li>You or your partner look after someone on leave from prison or a young offender’s institution on a temporary licence</li> 
    ...
    <p>*All individuals and families on low incomes face pressures. Exceptional pressure means a situation which causes additional pressure on an individual or family. 
...
<h3>How does the application process work</h3>
  ...
  <ul>
   <li>Self Service. You can fill in the form yourself on our website: <a href="www.sheffield.gov.uk/localassistance">Local Assistance</a>. The form can be filled in on a computer or mobile device.</li> 
...
const WhatWillIndepedenceGrantsBeMadeFor = new ContentB(
  ...
  "Description",
  `
<h3>What will Independence Grants be made for</h3>
 ...
 <p>It is not intended that a Sheffield Crisis Grant will be awarded to help with any of the following expenses: </p>
    ...
    <p> Under some circumstances a Sheffield Independence Grant could also be awarded to help with:</p>
...
const WhatWillNotIndependenceGrantsBeMadeFor = new ContentB(
  ...
  "Description",
  `
<h3>What will not Independence Grants be made for</h3>
...
<p>If you have provided us with an email address, written confirmation of the decision will be sent to you by email. If you do not have an email address, 
...
<h3>General Information</h3>
  ...
  <p>Residents facing hardship are currently able to apply for a Household Support fund nonerepayable grant if they are unable to meet the costs of food, 
...
<h3>How do I apply</h3>
 ...
 <p>Applications can be made on our website at <a href="www.sheffield.gov.uk/cost-of-living">Cost of Living</a>, if you need assistance to apply, 
...
<h3>Other Support Available</h3>
  ...
  <p>If a caller does not meet the eligibility criteria you should consider whether there are other hardship payments or support available to them 
...
<h3>What if I disagree with the decision</h3>
 ...
 <p>If you disagree with a decision about your application, you can request that the decision is reviewed by emailing <a href="HSF@sheffield.gov.uk">HSF@sheffield.gov.uk</a>, 
