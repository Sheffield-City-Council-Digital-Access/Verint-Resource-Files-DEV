...
`,{ buttonLabel: 'Apply for or renew a Blue Badge', formName: 'Blue_badge_application' },
  { typeKey: 'apply_blue_badge_transfered_to_service' },
  { typeKey: 'apply_blue_badge_information_provided' },
  {
    type: 'Application',
    keywords: ['Blue badge application', 'bluebadg', 'bleu badge', 'blue bage', 'bluebadje', 'blu badge','badg', 'bagde', 'badeg', 'badje', 'badgge',
      'blu', 'bleu', 'bluw', 'bloue', 'bule', 'applicotion', 'aplication', 'applcation', 'applicaton', 'aplicacion', 'applucation' ],
