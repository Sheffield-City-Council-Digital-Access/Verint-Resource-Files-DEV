...
const complaints2 = new ContentOoH(
  "complaints2",
  "Complaints2",
  "Description",
  `
...
const childrensSocialCareComplaints2 = new ContentOoH(
...
const adultsocialcarecomplaints2 = new ContentOoH(
...
const corporateComplaintsProcedure2 = new ContentOoH(
...
const outOfHours = new ServiceOoH(
  ...
  "Out of Hours",
  "Description",
    [complaints2, childrensSocialCareComplaints2, adultsocialcarecomplaints2, corporateComplaintsProcedure2]
);
