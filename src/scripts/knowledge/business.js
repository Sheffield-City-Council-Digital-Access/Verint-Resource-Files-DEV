...
const renewHackneyCarriage = new ContentBusiness(
    ...
    `
        ...
        <div class="accordion-content">
            <p>
                If the applicant does not currently hold a taxi driver licence with SCC, then they must provide a basic Disclosure and Barring Service (DBS) certificate.<br><br>
