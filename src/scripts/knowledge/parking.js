...
const whocanApplyforaBlueBadge = new ContentP(
  ...
  const blueBadgetakenbyanEnforcementOfficer = new ContentP(
	...
	<p>
	If your Blue Badge has been confiscated by an Enforcement Officer, please follow these steps:</p>
	<p>Send an e-mail to <a href="mailto:customerservices@sheffield.gov.uk">customerservices@sheffield.gov.uk</a>
	or send a letter to:
	</p> 
	...
	<p>
	In your message, please detail the circumstances that led to the Blue Badge being taken. 
	Once we receive this information, a member of our team will contact you, 
	and a decision will be made regarding the return of your Blue Badge.</p>
	`,
  ...
  const whoshouldIReportaboutaDeath = new ContentP(
	...
	`
	<p>
	If the customer has an appointment with Registrars in Sheffield to report the death, 
	they can sign up to <strong>Tell Us Once</strong> meaning the customer does not have to report 
	it to each individual service. Alternatively the details can be taken today and passed to our 
	back office team who will update our records, the badge should be returned to:
	</p> 
