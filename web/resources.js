...
function submitForm() {
  ...
  // KDF.custom("kdf-save-web", "_submit_function",textFieldNames + numberFieldNames + selectFields +  checkFieldNames + radioFieldNames + emailFieldNames + telFieldNames + dateFieldNames + timeFieldNames + "le_channel,le_eventcode,le_title,le_description,le_queue,le_associated_obj_type", "le_channel,le_eventcode,le_title,le_description,le_queue,le_associated_obj_type", true, true, true);
  console.log(textFieldNames, numberFieldNames, checkFieldNames, radioFieldNames, selectFields, emailFieldNames, telFieldNames, dateFieldNames, timeFieldNames);
